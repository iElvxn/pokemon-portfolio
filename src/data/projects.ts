...
export const projects: Project[] = [
  {
    ...
    hp: 420,
    techStack: ['AWS', 'TypeScript', 'React Native', 'Clerk', 'Expo'],
    achievements: [
    ...
    githubUrl: 'https://apps.apple.com/us/app/study-kitty/id6749342191',
  ...
  },
  {
    ...
    achievements: [
      ...
      'Eliminated LLM hallucinations via skill extraction, and citations achieving 85% skill recall.',
